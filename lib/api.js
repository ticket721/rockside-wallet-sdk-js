...
var RocksideApi = /** @class */ (function () {
    ...
    RocksideApi.prototype.createIdentity = function (forwarder, account) {
        return __awaiter(this, void 0, void 0, function () {
            var resp, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.send("/ethereum/" + this.opts.network[1] + "/smartwallets", 'POST', {
                            forwarder: forwarder,
                            account: account
                        })];
                    case 1:
    ...
    RocksideApi.prototype.getTransaction = function (txHashOrTrackingId) {
        return __awaiter(this, void 0, void 0, function () {
            var route, resp, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        route = "/ethereum/" + this.opts.network[1] + "/transactions/" + txHashOrTrackingId;
                        return [4 /*yield*/, this.send(route, 'GET', null)];
                    case 1:
                        resp = _a.sent();
                        if (!(resp.status != 200)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.extractError(resp)];
