...
var Rockside = /** @class */ (function () {
    ...
    Rockside.prototype.relayTransaction = function (signer, identity, tx) {
        return __awaiter(this, void 0, void 0, function () {
            var address, domain, nonce, relayer, params, message, hash, signature, transaction_response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        signature = _a.sent();
                        return [4 /*yield*/, this.api.relayTransaction(identity, __assign(__assign({}, tx), { from: signer.getAddress(), signature: signature }))];
                    case 4:
                        transaction_response = _a.sent();
                        return [2 /*return*/, transaction_response.transaction_hash];
                }
            });
        });
    };
